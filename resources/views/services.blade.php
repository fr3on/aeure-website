@extends('index')
@section('title', 'Services Domain | Aeure')
@section('description', 'Aeure is ideal for service organizations with a integrated projects and people management.')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="stunning-header stunning-header-bg-red">
            <div class="stunning-header-content">
                <h1 class="stunning-header-title">Services Domain</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <div class="heading mb30">
                                <h4 class="h1 heading-title">Services</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>

                                <h5 class="heading-subtitle">Aeure is ideal for service organizations with a integrated projects and people management.
                                </h5>
                            ...
                            <ul class="list list--secondary mb60">
                                ...
                                <li>
                                    <i class="seoicon-check"></i>
                                    <a href="#">HR and Payroll
                                    </a>
                                </li>

                                <li>
                                    <i class="seoicon-check"></i>
                                    <a href="#">Billing and Payments
                                    </a>
                                </li>
                        ...
                        <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                            <img src="svg/services.svg" alt="social">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">Project Management
                            </h4>
                            <p class="pie-chart-content-text">Manage all your projects with tasks, assignments and reminders and tracking expenses and billing.
            ...
            <div class="row mb60">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">HR and Payroll</h4>
                            <p class="pie-chart-content-text">Manage your employee data, payroll, leave and attendance, expense claims, all within your Aeure system.
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">Time Tracking
                            </h4>
                            <p class="pie-chart-content-text">Aeure helps you maintain timesheets against projects or tasks and also update them in bulk.
            ...
            <div class="row mb60">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">CRM and Sales</h4>
                            <p class="pie-chart-content-text">Track and follow up with leads and opportunites and send out rule based emails and newsletters.
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">Support Helpdesk</h4>
                            <p class="pie-chart-content-text">Manage your customer service and support with email integrated issue tracker.
