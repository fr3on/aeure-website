@extends('index')
@section('title', 'Distribution Domain | Aeure')
@section('description', 'Aeure is a perfect fit for distribution companies and helps you manage your inventory across multiple currencies and companies.')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="stunning-header stunning-header-bg-red">
            <div class="stunning-header-content">
                <h1 class="stunning-header-title">Distribution Domain</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <div class="heading mb30">
                                <h4 class="h1 heading-title">Distribution</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>

                                <h5 class="heading-subtitle">Aeure is a perfect fit for distribution companies and helps you manage your inventory across multiple currencies and companies.
                                </h5>
                        ...
                        <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                            <img src="svg/distribution.svg" alt="social">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb60">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">Multi Currency
                            </h4>
                            <p class="pie-chart-content-text">You can maintain prices, bill, track payments and maintain account balances in multiple currencies.
