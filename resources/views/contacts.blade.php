@extends('index')
@section('title', 'Contact Us | Aeure')
@section('description', 'We’re a company with 3 years of experience in developing enterprise resource planning software')
@section('content')
                ...
                <div class="contacts">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">+2 01033233462</a>
