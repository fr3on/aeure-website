@extends('index')
@section('title', 'Retail Domain | Aeure')
@section('description', 'Aeure can help you manage your shop or multiple shops with a web based POS with integrated inventory and accounting.')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="stunning-header stunning-header-bg-red">
            <div class="stunning-header-content">
                <h1 class="stunning-header-title">Retail Domain</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <div class="heading mb30">
                                <h4 class="h1 heading-title">Retail</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>

                                <h5 class="heading-subtitle">Aeure can help you manage your shop or multiple shops with a web based POS with integrated inventory and accounting.
                                </h5>
                        ...
                        <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                            <img src="svg/retail.svg" alt="social">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">Inventory
                            </h4>
            ...
            <div class="row mb60">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            ...
                            <p class="pie-chart-content-text">Aeure Item management helps you create and manage your manufacturing items and its variants.
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">Point of Sale
                            </h4>
                            <p class="pie-chart-content-text">The Aeure POS helps you manage your store checkout easily with integrated billing and inventory.
            ...
            <div class="row mb60">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="pie-chart-item">
                        ...
                        <div class="pie-chart-content">
                            <h4 class="pie-chart-content-title">HR and Payroll
                            </h4>
